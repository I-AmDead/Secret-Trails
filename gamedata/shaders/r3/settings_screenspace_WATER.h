...
#define G_SSR_WATER_SCREENFADE			0.5f	// Screen border fade. ( 0.0f = No border fade )
...
#define G_SSR_WATER_TURBIDITY			0.8f	// Water clarity. ( 0.0f = Clear ~ 1.0f = Murky )

#define G_SSR_WATER_RAIN				0.5f	// Max intensity of rain drops
...
#define G_SSR_WATER_CAUSTICS			0.7f	// Caustics intensity
#define G_SSR_WATER_CAUSTICS_SCALE		1.5f	// Caustics Size

#define G_SSR_WATER_SOFTBORDER			0.9f	// Soft border factor. ( 0.0f = hard edge )
