...
/// Taken from https://www.shadertoy.com/view/WldXR4
uint SLB_HilbertNoise(uint2 uv)
{
    // Hilbert curve:
...
float SLB_HilbertNoise_float(uint2 uv) { return SLB_ToFloat1(SLB_HilbertNoise(uv)); }
