...
#define G_SSR_STEPS           			16		// Max ray steps. More steps = "better" quality / poor performance. ( 8 = low | 16 = medium | 32 = high )
...
#define G_SSR_WEAPON_INTENSITY  		1.0f 	// Weapon & arms reflection intensity. 1.0f = 100% ~ 0.0f = 0% ( % in relation to G_SSR_INTENSITY )
