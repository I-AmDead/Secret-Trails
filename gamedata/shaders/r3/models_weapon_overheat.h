...
float4 overheat1(float2 uv)
{
    ...
    float3 c = normalize(0.75 - 0.25 * float3(
        sin(length(uv - float2(0.1, 0)) * 132.0 + T * 3.3),
        sin(length(uv - float2(0.9, 0)) * 136.0 - T * 2.5),
        sin(length(uv - float2(0.5, 1)) * 129.0 + T * 4.1)
    ));
