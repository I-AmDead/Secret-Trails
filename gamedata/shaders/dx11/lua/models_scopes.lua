...
function element_2(shader, t_base, t_second, t_detail)
	shader:begin("models_scope_reticle", "models_scope_reticle")
		...
		:sorting(2, true)
	shader:dx10texture("s_base", t_base)
	shader:dx10texture("s_prev_frame", "$user$postprocess")
	...
	shader:dx10texture("s_reflection_in", "wpn\\scope_utility\\reflection")
	shader:dx10texture("s_reflection_out", "$user$sky1")
